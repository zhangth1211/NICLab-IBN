"""
    The main function is primarily responsible for training the model on the PEMS08 dataset.
"""
...
adj_mx, _ = load_adj("../Test_Data/"  + data_name + "/" + "PEMS08_adj.pkl", "doubletransition")
...
"""-----------------------------Model Saving & Test-----------------------------------------"""
# Model Save
model_save_path = "../IBN_Best_Model_Save/PEMS08_Save/"
torch.save(best_net, model_save_path + "IBN_PEMS08_7_0.25.pt")
with open(model_save_path + "IBN_PEMS08_7_0.25.pt", "rb") as f:
    PEMS08_Best_Model = torch.load(f)
PEMS08_Best_Model.eval()
PEMS08_Best_Model= PEMS08_Best_Model.to(device2)
...
with torch.no_grad():
    ...
    for data in test_data:
        ...
        test_pre = PEMS08_Best_Model(test_feature)
        if num == 0:
            all_pre = test_pre
