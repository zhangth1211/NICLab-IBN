"""
    The main function is primarily responsible for training the model on the METR_LA dataset.
"""
import copy
...
adj_mx, _ = load_adj("../Test_Data/" + data_name + "/" + "METR_LA_adj.pkl", "doubletransition")
...
"""-----------------------------Model Saving & Test-----------------------------------------"""
# Model Save
model_save_path = "../IBN_Best_Model_Save/METR_LA_Save/"
torch.save(best_net, model_save_path + "IBN_METR_LA_7_0.25.pt")
with open(model_save_path + "IBN_METR_LA_7_0.25.pt", "rb") as f:
    METR_LA_Best_Model = torch.load(f)
METR_LA_Best_Model.eval()
METR_LA_Best_Model = METR_LA_Best_Model.to(device2)
...
with torch.no_grad():
    ...
    for data in test_data:
        ...
        test_pre = METR_LA_Best_Model(test_feature)
        if num == 0:
            all_pre = test_pre
